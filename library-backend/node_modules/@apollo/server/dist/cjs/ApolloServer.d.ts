...
import { type Resolvable } from '../../src/utils/resolvable.js';
...
import type { ExecuteOperationOptions, VariableValues } from '../../src/externalTypes/graphql.js';
import type { ApolloConfig, ApolloServerOptions, ApolloServerPlugin, BaseContext, ContextThunk, DocumentStore, GraphQLRequest, GraphQLResponse, HTTPGraphQLHead, HTTPGraphQLRequest, HTTPGraphQLResponse, LandingPage, PersistedQueryOptions } from '../../src/externalTypes/index.js';
import type { GraphQLExperimentalIncrementalExecutionResults } from '../../src/incrementalDeliveryPolyfill.js';
